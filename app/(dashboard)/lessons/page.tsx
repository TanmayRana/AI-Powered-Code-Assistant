...
export default function LessonsPage() {
  ...
  //     case "python":
  //       return "bg-gradient-to-r from-blue-50 to-indigo-100 text-blue-700 border border-blue-200 dark:from-blue-900/20 dark:to-indigo-900/30 dark:text-blue-300 dark:border-blue-800";
  //     case "javascript":
  //       return "bg-gradient-to-r from-purple-50 to-violet-100 text-purple-700 border border-purple-200 dark:from-purple-900/20 dark:to-violet-900/30 dark:text-purple-300 dark:border-purple-800";
  //     case "java":
  //       return "bg-gradient-to-r from-orange-50 to-red-100 text-orange-700 border border-orange-200 dark:from-orange-900/20 dark:to-red-900/30 dark:text-orange-300 dark:border-orange-800";
  //     case "react":
  //       return "bg-gradient-to-r from-cyan-50 to-blue-100 text-cyan-700 border border-cyan-200 dark:from-cyan-900/20 dark:to-blue-900/30 dark:text-cyan-300 dark:border-cyan-800";
  //     default:
  //       return "bg-gradient-to-r from-slate-50 to-gray-100 text-slate-700 border border-slate-200 dark:from-slate-900/20 dark:to-gray-900/30 dark:text-slate-300 dark:border-slate-800";
  //   }
  // };
  ...
  const getLanguageColor = (language: string) => {
    switch (language?.toLowerCase()) {
      case "python":
        return "bg-gradient-to-r from-blue-50 to-indigo-100 text-blue-700 border border-blue-200 dark:from-blue-900/20 dark:to-indigo-900/30 dark:text-blue-300 dark:border-blue-800";
      case "javascript":
        return "bg-gradient-to-r from-purple-50 to-violet-100 text-purple-700 border border-purple-200 dark:from-purple-900/20 dark:to-violet-900/30 dark:text-purple-300 dark:border-purple-800 text-white";
      case "java":
        return "bg-gradient-to-r from-orange-50 to-red-100 text-orange-700 border border-orange-200 dark:from-orange-900/20 dark:to-red-900/30 dark:text-orange-300 dark:border-orange-800";
      case "react":
        return "bg-gradient-to-r from-cyan-50 to-blue-100 text-cyan-700 border border-cyan-200 dark:from-cyan-900/20 dark:to-blue-900/30 dark:text-cyan-300 dark:border-cyan-800";
      case "butter":
        return "bg-gradient-to-r from-amber-50 to-yellow-100 text-amber-700 border border-amber-200 dark:from-amber-900/20 dark:to-yellow-900/30 dark:text-amber-300 dark:border-amber-800";
      case "dark":
        return "bg-gradient-to-r from-gray-800 to-black text-gray-100 border border-gray-700 dark:from-gray-900 dark:to-black dark:text-gray-200 dark:border-gray-600";
      case "light":
        return "bg-gradient-to-r from-white to-gray-50 text-gray-700 border border-gray-200 dark:from-gray-100 dark:to-gray-200 dark:text-gray-800 dark:border-gray-300";
      default:
        return "bg-gradient-to-r from-slate-50 to-gray-100 text-slate-700 border border-slate-200 dark:from-slate-900/20 dark:to-gray-900/30 dark:text-slate-300 dark:border-slate-800";
    }
  };
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      default:
        return "bg-slate-100 text-slate-700 border-slate-200 dark:bg-slate-900/20 dark:text-slate-300 dark:border-slate-800";
    }
  };
                  ...
                  <Card className="h-full border border-border bg-card flex flex-col">
                    <CardHeader className="pb-4">
                      <CardTitle className="flex items-center gap-3 text-xl">
                        {/* <div className="w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl flex items-center justify-center mx-auto mb-3">
